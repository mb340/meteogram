...
void Backend::writeCache(const QString &cacheContent, const QString &plasmoidId) {
    ...
    QString fileDir(QStandardPaths::writableLocation(QStandardPaths::CacheLocation) + "/plasmoids/org.kde.meteogram/");
    QDir().mkpath(fileDir);
...
QString Backend::readCache(const QString &plasmoidId) {
    ...
    fileName += "/plasmoids/org.kde.meteogram/plasmoidId-";
    fileName += plasmoidId;
    fileName += ".json";
