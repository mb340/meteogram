...
void Backend::writeCache(const QString &cacheContent, const QString &plasmoidId) {
    ...
    QString fileDir(QStandardPaths::writableLocation(QStandardPaths::CacheLocation) + "/plasmoids/org.kde.weatherWidget2/");
    QDir().mkpath(fileDir);
...
QString Backend::readCache(const QString &plasmoidId) {
    ...
    fileName += "/plasmoids/org.kde.weatherWidget2/plasmoidId-";
    fileName += plasmoidId;
    fileName += ".json";
